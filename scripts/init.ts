...
const MAX_DEPTH = 14;  // Supports up to 2^14 = ~16K deposits (reduced for size limits)
const MAX_BUFFER_SIZE = 8;   // Buffer for batching operations (reduced for size limits)
