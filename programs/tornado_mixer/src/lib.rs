...
// ---- Re-export Accounts types at crate root so we can use bare names in Context<...>
pub use crate::instructions::initialize::Initialize;
pub use crate::instructions::deposit::Deposit;
pub use crate::instructions::withdraw::Withdraw;

// ---- Private shims so #[program] can find the derive-generated helpers at crate root.
// Do NOT make these pub; the macro just `use`s them.
#[allow(non_snake_case)]
mod __client_accounts_initialize {
    pub use crate::instructions::initialize::__client_accounts_initialize::*;
}
#[allow(non_snake_case)]
mod __client_accounts_deposit {
    pub use crate::instructions::deposit::__client_accounts_deposit::*;
}
#[allow(non_snake_case)]
mod __client_accounts_withdraw {
