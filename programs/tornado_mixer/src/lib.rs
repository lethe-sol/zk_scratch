...
// ---- Re-export Accounts types at crate root (bare names) ----
...
// ---- Re-export the helper modules where the macro expects them ----
// These are generated by #[derive(Accounts)] in each file.
...
pub mod tornado_mixer {
    ...
    pub fn initialize(
        ctx: Context<Initialize>,   // ✅ bare type, helpers available at crate root
        _max_depth: u32,
    ...
    pub fn withdraw(
        ctx: Context<Withdraw>,     // ✅ bare type, helpers at crate root
        proof: [u8; 256],
        root: [u8; 32],
